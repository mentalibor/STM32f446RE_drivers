...
typedef struct
{
	uint8_t USART_Mode;				/*possible values at @USART_Mode*/
	uint32_t USART_Baud;			/*possible values at @USART_Baud*/
	uint8_t USART_NoOfStopBits;		/*possible values at @USART_ParityControl*/
	uint8_t USART_WordLength;		/*possible values at @USART_WordLength*/
	uint8_t USART_ParityControl;	/*possible values at @USART_NoOfStopBits*/
	uint8_t USART_HWFlowControl;	/*possible values at @USART_HWFlowControl*/
}USART_Config_t;
